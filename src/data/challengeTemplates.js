...
export const CHALLENGE_TEMPLATES = [
  ...
  },
  {
    ...
    purpose: 'Build focus, self-control, calm, and resilience through daily mental training.',
    ...
    insights_triggers: {
      ...
      in_progress_monitoring: 'stress_rating, confidence_rating, mood_rating, completion',
    },
    ...
    safety_flags: {
      ...
      notes: 'This is for daily mental training, not a replacement for professional care.',
    },
    ...
    variants: {
      beginner: {
        difficulty: 'easy',
        required_daily_tasks: [
          'Complete 2 minutes of breathwork or stillness.',
          'Write one daily win.',
          'Log stress.',
          'Read or reflect on Quote of the Day.',
        ],
        optional_tasks: [
          'Prayer/reflection.',
          'Gratitude note.',
      ...
      standard: {
        difficulty: 'medium',
        required_daily_tasks: [
          'Complete 5–10 minutes of breathwork, meditation, prayer, or NSDR.',
          'Write one daily win.',
          'Write one thing you controlled well today.',
          'Log stress and confidence.',
          'Complete Quote of the Day reflection.',
        ],
        optional_tasks: [
      ...
      hard: {
        difficulty: 'hard',
        required_daily_tasks: [
          'Complete 10–20 minutes of mental training.',
          'Complete one 90-minute phone-free focus block.',
          'Write one daily win and one lesson.',
          'Complete Quote/Faith reflection if enabled.',
