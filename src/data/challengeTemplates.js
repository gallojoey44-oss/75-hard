    ...
    variants: {
      beginner: {
        ...
        start_tasks: [
          ...
          { id: 'mt_reflect', name: 'Quote/reflection complete',           icon: '📜', color: '#DDA0DD' },
        ],
      },
      standard: {
        difficulty: 'medium',
        ...
        start_tasks: [
          ...
          { id: 'mt_reflect', name: 'Quote of the Day reflection',         icon: '📜', color: '#DDA0DD' },
      ...
      hard: {
        ...
        start_tasks: [
          ...
          { id: 'mt_reflect', name: 'Quote/Faith reflection',              icon: '📜', color: '#DDA0DD' },
